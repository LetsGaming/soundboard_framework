...
REQUIREMENTS_TEMPLATE = "soundboard-framework @ git+https://github.com/LetsGaming/soundboard_framework.git\n"
...
def main() -> None:
    ...
    print(f"  4. pip install -r requirements.txt  # from inside {character_dir}")
